	...
	<div class="col-lg-12">
		<form id="manage-flight">
			...
			<div class="row">
				<div class="col-md-8">
					<div class="form-group">
						<label for="" class="control-label">Онгоцны маяг /type/</label>
			...
			<div class="row">
				<div class="col-md-8">
					<div class="form-group">
						<label for="">Нислэгийн төлөв / Flight status</label>
			...
			<div class="row form-group">
				<div class="col-md-6">
					<div class="">
						<label for="">Хөөрcөн буудал/Departure Location<</label>
				...
				<div class="col-md-6">
					<div class="">
						<label for="">Буусан буудал/Arrival Location</label>
			...
			<div class="row form-group">
				<div class="col-md-6">
					<div class="">
						<label for="">Хөөрсөн он-сар-өдөр/Departure Data/Time</label>
				...
				<div class="col-md-6">
					<div class="">
						<label for="">Хөөрсөн цаг/Take off time</label>
						<input type="time" name="take_off_time" id="take_off_time" class="form-control text-right" value="">
					</div>
				</div>
				<div class="col-md-6">
					<div class="">
						<label for="">Буусан он-сар-өдөр/Arrival Data/Time</label>
				...
				<div class="col-md-6">
					<div class="">
						<label for="">Буусан цаг/Landing time</label>
						<input type="time" name="landing_time" id="landing_time" class="form-control text-right" value="">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6">
					<div class="">
						<label for="">Хоолойгоос түлхүүлсэн цаг / Off block time</label>
						<input name="seats" id="seats" type="time" step="any" class="form-control text-right" value="<?php echo isset($seats) ? $seats : '' ?>">
					</div>
				</div>
				<div class="col-md-6">
					<div class="">
						<label for="">Хоолойд орсон цаг / On block time</label>
						<input name="price" id="price" type="time" step="any" class="form-control text-right" value="<?php echo isset($price) ? $price : '' ?>">
					</div>
				</div>
			</div>
		</form>
