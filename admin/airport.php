			...
			<form action="" id="manage-airports">
				<div class="card">
					<div class="card-header">
						   <b>Нисэх буудлын мэдээлэл / Airport's Form</b>
				  	</div>
					<div class="card-body">
							<input type="hidden" name="id">
							<div class="form-group">
								<label class="control-label">Нисэх буудлын нэр / Airport</label>
								<textarea name="airport" id="" cols="30" rows="2" class="form-control"></textarea>
							</div>
							<div class="form-group">
								<label class="control-label">Нисэх буудлын байршил / Location</label>
						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="text-center">Нисэх буудлын нэр / Airport</th>
									<th class="text-center">Нисэх буудлын байршил / Location</th>
