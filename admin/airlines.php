			...
			<form action="" id="manage-airlines">
				<div class="card">
					<div class="card-header">
						   <b>Шинэ онгоц нэмэх / Add new aircraft</b>
				  	</div>
					<div class="card-body">
							<input type="hidden" name="id">
							<div class="form-group">
								<label class="control-label"> Онгоцны бүртгэлийн дугаар/Маяг /Aircraft's registeration number/type</label>
								<textarea name="airlines" id="" cols="30" rows="2" class="form-control"></textarea>
							</div>
							<div class="form-group">
								<label for="" class="control-label">Онгоцны зураг </label>
						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="text-center">Онгоцны зураг / Aircraft image</th>
									<th class="text-center">Онгоцны бүртгэлийн дугаар/Маяг /Aircraft's registeration number/type</th>
