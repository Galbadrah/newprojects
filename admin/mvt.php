			...
			<form action="" id="manage-airports">
				<div class="card">
					<div class="card-header">
						  <b> MVT МЭДЭЭ ОРУУЛАХ </b>
				  	</div>
					<div class="card-body">
							<input type="hidden" name="id">
							<div class="form-group">
								<label class="control-label"><b>МЭДЭЭЭНИЙ ТӨРӨЛ</b></label>
								<textarea name="airport" id="" cols="30" rows="2" class="form-control"></textarea>
							</div>
							<div class="form-group">
								<label class="control-label"><b>MVT МЭДЭЭ</b></label>
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								<button class="btn btn-sm btn-primary col-sm-3 offset-md-3"> ХАДГАЛ</button>
								<button class="btn btn-sm btn-default col-sm-3" type="button" onclick="_reset()"> ЦУЦАЛ</button>
							</div>
						</div>
					</div>
				</div>
						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="text-center">МЭДЭЭНИЙ ТӨРӨЛ</th>
									<th class="text-center">MVT МЭДЭЭ</th>
							...
							<tbody>
								<?php 
								$i = 1;
								$cats = $conn->query("SELECT * FROM mvt_ins order by id asc");
